...
def test_assign_nested_dict_list_pydantic(impl: Callable):
...
def test_assign_dict_str_model(impl: Callable):
...
def test_assign_list_model_nested(impl: Callable):
...
def test_assign_complex_nested_path(impl: Callable):
...
def test_assign_model_list_in_dict(impl: Callable):
...
def test_assign_deeply_nested_mixed(impl: Callable):
...
def test_assign_model_to_none_address(impl: Callable):
...
def test_assign_with_missing_callback(impl: Callable):
...
def test_assign_with_missing_pydantic_in_dict(impl: Callable):
...
def test_assign_list_index_in_pydantic(impl: Callable):
...
def test_assign_returns_original_object(impl: Callable):
...
def test_assign_string_path_vs_tuple_path(impl: Callable):
